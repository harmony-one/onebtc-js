...
import { createClientHmy } from '../src';
import { OneBTCClientHmy } from '../src/blockchain/hmy/OneBTCClientHmy';

dovenv.config();

describe('hmyClient', function () {
  let web3Client: OneBTCClientHmy;

  beforeEach(async () => {
    web3Client = await createClientHmy({
